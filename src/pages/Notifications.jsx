      ...
      <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-primary-blue to-primary-purple text-white rounded-lg font-semibold hover:opacity-90 transition-opacity flex items-center gap-2"
              >
                <CheckCheck size={18} />
                Mark All Read
              </button>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-2 rounded-lg border bg-transparent outline-none focus:border-primary-blue transition-colors ${isDarkMode ? 'text-text-dark border-border-dark' : 'text-text-light border-border-light'}`}
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-colors ${filter === 'all' ? 'bg-primary-blue text-white' : isDarkMode ? 'text-text-dark hover:bg-card-dark' : 'text-text-light hover:bg-card-light'}`}
              >
                All
              </button>
              <button
                onClick={() => setFilter('unread')}
                className={`px-4 py-2 rounded-lg font-medium transition-colors ${filter === 'unread' ? 'bg-primary-blue text-white' : isDarkMode ? 'text-text-dark hover:bg-card-dark' : 'text-text-light hover:bg-card-light'}`}
              >
                Unread
              </button>
              <button
                onClick={() => setFilter('read')}
                className={`px-4 py-2 rounded-lg font-medium transition-colors ${filter === 'read' ? 'bg-primary-blue text-white' : isDarkMode ? 'text-text-dark hover:bg-card-dark' : 'text-text-light hover:bg-card-light'}`}
              >
                Read
              </button>
            </div>
        ...
        >
          {filteredNotifications.length === 0 ? (
            <div className={`p-12 rounded-2xl border text-center ${isDarkMode ? 'bg-card-dark border-border-dark' : 'bg-card-light border-border-light'}`}>
              <Bell className={`mx-auto mb-4 opacity-50 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`} size={48} />
              <p className={`text-lg font-semibold mb-2 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
            ...
            filteredNotifications.map((notification, index) => (
              <motion.div
                ...
                className={`p-6 rounded-2xl border relative ${!notification.read ? 'border-l-4 border-l-primary-blue' : ''} ${isDarkMode ? 'bg-card-dark border-border-dark' : 'bg-card-light border-border-light'}`}
              >
                <button
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                      <h3 className={`font-bold ${!notification.read ? 'text-primary-blue' : ''} ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
                        {notification.title}
                      </h3>
                      {!notification.read && (
                        <span className="w-2 h-2 bg-primary-blue rounded-full flex-shrink-0 mt-2" />
                      )}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-sm opacity-50">
                        <Clock size={14} />
                        <span className={isDarkMode ? 'text-text-dark' : 'text-text-light'}>
                          {notification.time}
                        </span>
                      </div>
        ...
        <motion.div
          ...
          className={`mt-8 p-6 rounded-2xl border ${isDarkMode ? 'bg-card-dark border-border-dark' : 'bg-card-light border-border-light'}`}
        >
          <h3 className={`font-bold mb-4 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
            Notification Types
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              <div key={index} className="flex items-center gap-2">
                ...
                <span className={`text-sm ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>{type.label}</span>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <div className={`p-6 rounded-2xl border flex items-center gap-4 ${isDarkMode ? 'bg-card-dark border-border-dark' : 'bg-card-light border-border-light'}`}>
            ...
            <div>
              <h4 className={`font-bold mb-1 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Smart Alerts</h4>
              <p className={`text-sm opacity-70 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
          ...
          <div className={`p-6 rounded-2xl border flex items-center gap-4 ${isDarkMode ? 'bg-card-dark border-border-dark' : 'bg-card-light border-border-light'}`}>
            ...
            <div>
              <h4 className={`font-bold mb-1 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Location-Based</h4>
              <p className={`text-sm opacity-70 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
          ...
          <div className={`p-6 rounded-2xl border flex items-center gap-4 ${isDarkMode ? 'bg-card-dark border-border-dark' : 'bg-card-light border-border-light'}`}>
            ...
            <div>
              <h4 className={`font-bold mb-1 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Real-Time</h4>
              <p className={`text-sm opacity-70 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
                Instant updates
              </p>
            </div>
