...
import {
  ...
  Home, Store, Activity, ChevronRight, MessageCircle, Mail, Copy, Check, X, ExternalLink
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
              ...
              <Link 
                ...
                className="px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-[#2563eb] to-[#7c3aed] text-white rounded-xl font-semibold hover:opacity-90 transition-opacity flex items-center justify-center gap-1.5 sm:gap-2 text-sm sm:text-base"
              >
                View Businesses
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6">
            <div>
              <h2 className={`text-lg sm:text-xl font-bold mb-1.5 sm:mb-2 ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              <div className="text-center">
                <div className="text-3xl sm:text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-[#2563eb] to-[#7c3aed] bg-clip-text text-transparent">
              ...
              <div className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-full font-semibold text-xs sm:text-sm ${areaData.marketScore != null && areaData.marketScore >= 80 ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : areaData.marketScore != null && areaData.marketScore >= 60 ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400' : areaData.marketScore != null ? 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400' : 'bg-gray-100 text-gray-600'}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 mb-6 sm:mb-8">
          ...
          <motion.div
            ...
            className={`p-4 sm:p-6 rounded-2xl border ${isDarkMode ? 'bg-[#1e293b] border-[#334155]' : 'bg-[#ffffff] border-[#e2e8f0]'}`}
          >
            ...
            <div className="text-center mb-4">
              <div className="text-3xl sm:text-4xl font-extrabold bg-gradient-to-r from-[#2563eb] to-[#7c3aed] bg-clip-text text-transparent">
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
            <Building className="text-[#2563eb]" size={22} />
            <h3 className={`text-base sm:text-xl font-bold ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>
              Residential vs Commercial
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
            <div>
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                ...
                <span className={`font-semibold text-sm sm:text-base ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>Residential</span>
              </div>
              <div className="text-2xl sm:text-3xl font-bold text-green-500 mb-1.5 sm:mb-2">{Number(areaData.residentialCommercial.residential || 0).toFixed(2)}%</div>
              <div className="w-full h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
            ...
            <div>
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                ...
                <span className={`font-semibold text-sm sm:text-base ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>Commercial</span>
              </div>
              <div className="text-2xl sm:text-3xl font-bold text-blue-500 mb-1.5 sm:mb-2">{Number(areaData.residentialCommercial.commercial || 0).toFixed(2)}%</div>
              <div className="w-full h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 mb-6 sm:mb-8">
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              <Car className="text-[#2563eb]" size={22} />
              <h3 className={`text-base sm:text-xl font-bold ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>
                Traffic Level
              </h3>
            </div>
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              <Navigation className="text-[#2563eb]" size={22} />
              <h3 className={`text-base sm:text-xl font-bold ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>
                Nearby Landmarks
              </h3>
            </div>
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-3">
              <Store className="text-[#2563eb]" size={22} />
              <h3 className={`text-base sm:text-lg md:text-xl font-bold ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>
                Nearby Business Categories
              </h3>
            </div>
            <Link 
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4">
            {nearbyBusinesses.length > 0 ? nearbyBusinesses.map((business, index) => (
              ...
              >
                <div className={`w-10 h-10 sm:w-12 sm:h-12 ${business.color} rounded-lg flex items-center justify-center mx-auto mb-2 sm:mb-3`}>
                  <business.icon className="text-white" size={20} />
                </div>
                <p className={`text-xs sm:text-sm font-semibold mb-0.5 sm:mb-1 truncate ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>
                  {business.category}
                </p>
                <p className={`text-base sm:text-lg font-bold ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>
                  {business.count}
                </p>
              </motion.div>
            )) : (
        ...
        >
          <Link 
            to={`/business-overview/${areaData.pincode}`}
            className={`p-4 sm:p-6 rounded-2xl border flex items-center gap-3 sm:gap-4 transition-all hover:-translate-y-1 ${isDarkMode ? 'bg-[#1e293b] border-[#334155] hover:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.3)]' : 'bg-[#ffffff] border-[#e2e8f0] hover:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1)]'}`}
          >
            ...
            <div className="min-w-0">
              <h4 className={`font-bold mb-0.5 sm:mb-1 text-sm sm:text-base ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>Business Overview</h4>
              <p className={`text-xs sm:text-sm opacity-70 ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>View existing businesses</p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="min-w-0">
              <h4 className={`font-bold mb-0.5 sm:mb-1 text-sm sm:text-base ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>Market Analysis</h4>
              <p className={`text-xs sm:text-sm opacity-70 ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>Detailed market insights</p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="min-w-0">
              <h4 className={`font-bold mb-0.5 sm:mb-1 text-sm sm:text-base ${isDarkMode ? 'text-[#f1f5f9]' : 'text-[#1e293b]'}`}>AI Recommendations</h4>
