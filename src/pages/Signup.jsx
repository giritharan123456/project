            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className={`p-4 rounded-xl ${isDarkMode ? 'bg-[#0f172a]' : 'bg-[#f8fafc]'}`}>
                ...
                <ul className="space-y-1">
                  <li className={`text-xs flex items-center gap-2 ${formData.password.length >= 8 ? 'text-green-500' : 'opacity-50'}`}>
                    <CheckCircle size={12} /> At least 8 characters
                  </li>
                  <li className={`text-xs flex items-center gap-2 ${/[A-Z]/.test(formData.password) ? 'text-green-500' : 'opacity-50'}`}>
                    <CheckCircle size={12} /> One uppercase letter
                  </li>
                  <li className={`text-xs flex items-center gap-2 ${/[0-9]/.test(formData.password) ? 'text-green-500' : 'opacity-50'}`}>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <button
                  type="button"
                  disabled
                  className={`py-3 rounded-xl border font-semibold transition-colors flex items-center justify-center gap-2 opacity-50 cursor-not-allowed ${isDarkMode ? 'text-[#f1f5f9] border-[#334155]' : 'text-[#1e293b] border-[#e2e8f0]'}`}
                >
