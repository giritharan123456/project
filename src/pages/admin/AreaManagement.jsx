        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage all areas across districts</p>
            </div>
            <button
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Income Level</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {areas.map((area) => (
                  <tr key={area._id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{area.pincode}</td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{area.incomeLevel}</td>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 my-8">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Population Growth (%)</label>
                  <input
                    type="number"
                    step="0.1"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Urban Development Score</label>
                  <input
                    type="number"
                    min="0"
                    max="100"
