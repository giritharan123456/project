      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {[
            ...
            >
              ...
              <p className={`text-sm opacity-70 mb-1 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>{forecast.label}</p>
              <div className="flex items-end gap-2 mb-2">
                <span className={`text-2xl font-bold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
                  {forecast.current}
                </span>
                <TrendingUp className="text-green-500 mb-1" size={16} />
                <span className={`text-lg font-semibold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
                  {forecast.future}
                </span>
              </div>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <LineChart className="text-primary-blue" size={24} />
              <h3 className={`text-xl font-bold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
                5-Year Prediction
              </h3>
            </div>
            <div className="flex items-center gap-2">
              <Info className={`opacity-50 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`} size={16} />
          ...
          <div className="space-y-6">
            <div>
              <div className="flex justify-between mb-2">
                <span className={`text-sm font-medium ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Population Growth</span>
            ...
            <div>
              <div className="flex justify-between mb-2">
                <span className={`text-sm font-medium ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Demand Growth</span>
                <span className={`text-sm font-medium ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
            ...
            <div>
              <div className="flex justify-between mb-2">
                <span className={`text-sm font-medium ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Competition Growth</span>
                <span className={`text-sm font-medium ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
            ...
            <div>
              <div className="flex justify-between mb-2">
                <span className={`text-sm font-medium ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Revenue Growth</span>
                <span className={`text-sm font-medium ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
            ...
            <table className="w-full">
              <thead>
                <tr className={`border-b ${isDarkMode ? 'border-border-dark' : 'border-border-light'}`}>
                  <th className={`text-left p-4 font-semibold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Year</th>
                  <th className={`text-left p-4 font-semibold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Population</th>
                  <th className={`text-left p-4 font-semibold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Demand</th>
                  <th className={`text-left p-4 font-semibold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Competition</th>
                  <th className={`text-left p-4 font-semibold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Revenue</th>
                </tr>
              </thead>
              <tbody>
                {predictions.map((prediction, index) => (
                  <motion.tr
                    ...
                    className={`border-b ${isDarkMode ? 'border-border-dark' : 'border-border-light'} hover:bg-opacity-50 ${isDarkMode ? 'hover:bg-card-dark' : 'hover:bg-card-light'}`}
                  >
                    <td className={`p-4 font-semibold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>{prediction.year}</td>
                    <td className={`p-4 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>{prediction.population}</td>
                    <td className={`p-4 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>{prediction.demand}</td>
                    <td className={`p-4 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>{prediction.competition}</td>
                    <td className={`p-4 font-semibold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>{prediction.revenue}</td>
                  </motion.tr>
                ))}
              </tbody>
            </table>
            ...
            {futureTrends.map((trend, index) => (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className={`font-semibold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>{trend.trend}</p>
                ...
                <div className="flex items-center justify-between">
                  <span className={`text-sm opacity-70 ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>Confidence</span>
                  <span className={`text-sm font-semibold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>{trend.confidence}%</span>
                </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <CheckCircle className="text-primary-blue" size={24} />
            <h3 className={`text-xl font-bold ${isDarkMode ? 'text-text-dark' : 'text-text-light'}`}>
              Forecast Confidence
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-4xl font-extrabold bg-gradient-to-r from-primary-blue to-primary-purple bg-clip-text text-transparent mb-2">
                82%
              </div>
