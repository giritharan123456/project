...
function FilterPanel({ onFilter, selectedCategory, categories }) {
  ...
  return (
    <div className={`p-4 sm:p-6 rounded-xl border mb-6 transition-all duration-300 sticky top-4 z-30 ${isDarkMode ? 'bg-[#1e293b] border-[#334155] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.3),0_2px_4px_-1px_rgba(0,0,0,0.2)]' : 'bg-[#ffffff] border-[#e2e8f0] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)]'}`}>
