...
const getSmartResponse = async (query) => {
  ...
  // Check if user is asking about a specific pincode (6 digits)
  ...
  if (pincodeMatch) {
    ...
    if (area) {
      ...
      // Pincode not found - try to generate basic info
  ...
  // Check if user is asking about a specific district
  ...
  // Investment / cost / budget / money / price / how much
  ...
  // Which / what / where / why / how questions
  ...
  // Default — try to find any matching area or category name
